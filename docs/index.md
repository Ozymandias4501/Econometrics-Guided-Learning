...
1. [Notebook: 00_descriptive_statistics](../notebooks/00a_statistics_primer/00_descriptive_statistics.ipynb)
   Guide: [00_descriptive_statistics](guides/00a_statistics_primer/00_descriptive_statistics.md)
2. [Notebook: 01_probability_distributions](../notebooks/00a_statistics_primer/01_probability_distributions.ipynb)
   Guide: [01_probability_distributions](guides/00a_statistics_primer/01_probability_distributions.md)
3. [Notebook: 02_sampling_and_central_limit_theorem](../notebooks/00a_statistics_primer/02_sampling_and_central_limit_theorem.ipynb)
   Guide: [02_sampling_and_central_limit_theorem](guides/00a_statistics_primer/02_sampling_and_central_limit_theorem.md)
4. [Notebook: 03_z_scores_and_standardization](../notebooks/00a_statistics_primer/03_z_scores_and_standardization.ipynb)
   Guide: [03_z_scores_and_standardization](guides/00a_statistics_primer/03_z_scores_and_standardization.md)
5. [Notebook: 04_confidence_intervals](../notebooks/00a_statistics_primer/04_confidence_intervals.ipynb)
   Guide: [04_confidence_intervals](guides/00a_statistics_primer/04_confidence_intervals.md)
6. [Notebook: 05_hypothesis_testing_foundations](../notebooks/00a_statistics_primer/05_hypothesis_testing_foundations.ipynb)
   Guide: [05_hypothesis_testing_foundations](guides/00a_statistics_primer/05_hypothesis_testing_foundations.md)
7. [Notebook: 06_common_statistical_tests](../notebooks/00a_statistics_primer/06_common_statistical_tests.ipynb)
   Guide: [06_common_statistical_tests](guides/00a_statistics_primer/06_common_statistical_tests.md)
8. [Notebook: 07_correlation_and_covariance](../notebooks/00a_statistics_primer/07_correlation_and_covariance.ipynb)
   Guide: [07_correlation_and_covariance](guides/00a_statistics_primer/07_correlation_and_covariance.md)
9. [Notebook: 08_bayesian_vs_frequentist](../notebooks/00a_statistics_primer/08_bayesian_vs_frequentist.ipynb)
   Guide: [08_bayesian_vs_frequentist](guides/00a_statistics_primer/08_bayesian_vs_frequentist.md)

### Foundations
1. [Notebook: 00_setup](../notebooks/00b_foundations/00_setup.ipynb)  
   Guide: [00_setup](guides/00b_foundations/00_setup.md)
2. [Notebook: 01_time_series_basics](../notebooks/00b_foundations/01_time_series_basics.ipynb)  
   Guide: [01_time_series_basics](guides/00b_foundations/01_time_series_basics.md)
3. [Notebook: 02_stats_basics_for_ml](../notebooks/00b_foundations/02_stats_basics_for_ml.ipynb)  
   Guide: [02_stats_basics_for_ml](guides/00b_foundations/02_stats_basics_for_ml.md)
