# Guide: 03_model_cards_and_reporting
...
This guide accompanies the notebook `notebooks/05_model_ops/03_model_cards_and_reporting.ipynb`.
...
- Complete notebook section: Model card
- Complete notebook section: Reporting
- Complete notebook section: Limitations
