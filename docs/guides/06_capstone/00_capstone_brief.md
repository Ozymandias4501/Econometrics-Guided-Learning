...
This guide accompanies the notebook `notebooks/06_capstone/00_capstone_brief.ipynb`.
...
- Complete notebook section: Deliverables
- Complete notebook section: Rubric
- Complete notebook section: Scope selection
